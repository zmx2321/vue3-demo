...
export const glMapConfig = (id, geoData, center, zoom) => ({
  container: id, // 容器的id
  center: center || [120.1, 29.25], // 初始位置，经度纬度 [lng, lat]
  zoom: zoom || 6.45, // 初始缩放
  // minZoom: 6,
  pitch: 20,
  antialias: true, // 抗锯齿
 ...
 */
// 原始配置1 - 老规范
export const glMapConfigTest0 = (id, geoData, center, zoom) => ({
  container: id, // 容器的id
  center: center || [120.5, 28.8], // 初始位置，经度纬度 [lng, lat]
  zoom: zoom || 6.5, // 初始缩放
  minZoom: 6,
...
// 原始配置1-1 - 老规范 - 不带底图
export const glMapConfigTest0t1 = (id, geoData, center, zoom) => ({
  container: id, // 容器的id
  center: center || [120.5, 28.8], // 初始位置，经度纬度 [lng, lat]
  zoom: zoom || 6.5, // 初始缩放
  minZoom: 6,
...
// 配置1和配置2结合
export const glMapConfigTest3 = (id, geoData, center, zoom) => ({
  container: id, // 容器的id
  center: center || [120.1, 29.25], // 初始位置，经度纬度 [lng, lat]
  zoom: zoom || 6.45, // 初始缩放
  // minZoom: 6,
